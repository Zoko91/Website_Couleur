    ...
    <nav class="navbar navbar-inverse" style="margin-top: 15px;justify-content: center;">
        <div id="block" class="container-fluid">
            <ul id="list" class="nav">
                ...
                <li><a id="len2" class="hoverable" href="#">Teinte</a></li>
...
<div class="container" style="margin-top:5vh">
    ...
    <div id="goNext" class="row" style="margin-top:5vh">
        ...
        <div class="col-3">
            <button type="button" class="fill" id="precedTeinte">Précédent</button>
        </div>
        <div class="col-2" class="textToFIll" id="resultTeinte">
            Résultat :
        </div>
        <div class="col-3">
            <button type="button" class="slide" id="suivantTeinte">
                <div>Suivant</div>
